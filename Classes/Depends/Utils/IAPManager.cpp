...
//            DecUnitManager::getInstance()->unlockTypes(getIapTypeNames(i));
            break;
        }
    }
//    unlock解锁  所有都解锁
...
//    else if(sId.compare(getIapKeyString(1)) == 0) //unlock all
//    {
//        //最后一个广告不解锁
//        for (int i = 2; i < IAPCount-1 ; i++) {
//            setItemBoughtWithIndex(i);
//        }
//    }
