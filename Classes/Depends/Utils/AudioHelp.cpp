...
void AudioHelp::playResetEffect(){
    SimpleAudioEngine::getInstance()->playEffect("sound/basic/reset.caf");
}

void AudioHelp::playStartEffect(){
    SimpleAudioEngine::getInstance()->playEffect("sound/basic/play.mp3");
}
...
{
    SimpleAudioEngine::getInstance()->playEffect("sound/basic/take_photo.mp3");
}
...
void AudioHelp::playPourWaterEffect()
{
    ...
    gPourWaterId = _playEffect("water.mp3");
}
