...
enum{
    ...
    //    lemonade
    eSceneTagCutLemon,
    eSceneTagMakeLemonade,
    eSceneTagChooseLemonadeFlavor,
    eSceneTagMixLemonade,
    
    //    hotdoge
    eSceneTagGetHotdogIngredient,
    eSceneTagMixHotdog,
    eSceneTagChooseHotdogStick,
    eSceneTagCoatHotdog,
    eSceneTagFryHotdog,
    
    //frybread
    eSceneTagMixBread,
    eSceneTagCutBreadDough,
    eSceneTagFryBread,
    
    //funnelcake
    eSceneTagChooseFunnelCakeFlavor,
    eSceneTagMixFunnelFlour,
    eSceneTagFunnelPour,
    eSceneTagFryFunnel,
    eSceneTagSugaringFunnel,
    
    //churro
    eSceneTagMixChurro,
    eSceneTagChurroPour,
    eSceneTagFryChurro,
    eSceneTagAddChurroSauce,
    
    //burrito
    eSceneTagMixBurritoMeat,
    eSceneTagMixBurritoSauce,
    eSceneTagMixBurritoStuffing,
    eSceneTagPutBurritoStuffing,

    eSceneTagRollBurrito,
    
    //snowcone
    eSceneTagSnowconeTake,
    eSceneTagSnowconeShake,
    eSceneTagSnowconeMake,
    eSceneTagSnowconeGet,
    eSceneTagSnowconeChoose,
    eSceneTagSnowconeScribble,

//    mac cheese
    eSceneTagMixFlour,
    eSceneTagAddFavouring,
    eSceneTagMakeCheese,
    eSceneTagMixCheese,
    eSceneTagPourMixture,
    eSceneTagPourCrumb,
    eSceneTagBake,
    eSceneTagPutStuffing,
