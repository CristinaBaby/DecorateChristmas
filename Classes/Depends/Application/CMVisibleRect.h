...
public: // 原来的代码，以后应该废弃的
    CC_DEPRECATED_ATTRIBUTE static void setPosition(Node* node, float x, float y, bool bTop = false, bool bBottom = false, bool bLeft = false, bool bRight = false);
    
    CC_DEPRECATED_ATTRIBUTE static void setPosition(Node* node, Vec2 pt, bool bTop = false, bool bBottom = false, bool bLeft = false, bool bRight = false);
